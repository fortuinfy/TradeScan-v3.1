// =========================
// TRADE REASONING ENGINE // TRADESCAN V3.1
// =========================
function generateTradeReasons(data) {
  ...
  if (pnlPercent > 0) {
    reasons.push(
      "Trade remains profitable with current gain of " + pnlPercent.toFixed(2) + "%."
    );
  } else {
    reasons.push(
  ...
  if (advancedEnabled) {
    ...
    reasons.push(
      "Momentum Health: " + momentumHealth
    );
    reasons.push(
